   ...
   fDetectorConstruction(Det)
{
  ...
  fAbsThickCmd = new G4UIcmdWithADoubleAndUnit("/B2/det/setTargetThick",this);
  fAbsThickCmd->SetGuidance("Set Thickness of the Target.");
...
void B2aDetectorMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{
  ...
  {fDetectorConstruction->SetTargetThickness(fAbsThickCmd->GetNewDoubleValue(newValue));}
}
