...
class B2TrackerHit : public G4VHit
{
  public:
    ...
    // void SetP        (G4ThreeVector PxPyPz){ fP = PxPyPz; };
    // void SetPdirection (G4ThreeVector Pdirection){ fPdirection = Pdirection; };
    void SetPdir        (G4double Pdir)      { fPdir = Pdir; };
    void SetE        (G4double E)      { fE = E; };
    void SetHasEBrem (G4bool hasEBrem) { fHasEBrem = hasEBrem; };
    void SetHasEIoni (G4bool hasEIoni) { fHasEIoni = hasEIoni; };
    ...
    // G4ThreeVector GetPdirection() const { return fPdirection; };
    G4double GetPdir() const     { return fPdir; };
    G4double GetE() const     { return fE; };
    G4bool   GetHasEBrem() const { return fHasEBrem; };
    G4bool   GetHasEIoni() const { return fHasEIoni; };
...
using B2TrackerHitsCollection = G4THitsCollection<B2TrackerHit>;
